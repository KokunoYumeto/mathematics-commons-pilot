# Earlier pilot material

This repository began as a governance and research-packet pilot. Its original documents, calibration example, Git history, tags, and releases remain available as historical evidence.

- `v0.1.0` and `v0.1.1` are concept/source releases, not runnable transcription jobs.
- `examples/calibration/` is an elementary protocol calibration and is explicitly not a live packet queue.
